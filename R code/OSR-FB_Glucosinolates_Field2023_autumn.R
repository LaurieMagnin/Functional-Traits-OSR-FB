...
EVA_Gluco <- subset(EVA_Gluco, EVA_Gluco$Sampling_campain == "EVA_2_BF")
...
model <- lm(Gluconasturtiin ~ bloc + variety*culture  , data=EVA_Gluco) #calculer le model, la covariable passe en premier 
...
anova_table <- EVA_Gluco  %>% anova_test(Gluconasturtiin ~ bloc + variety*culture )
...
write.csv(anova_results, "~/working/Aboveground_characterization/3-Output/anova_results_EVA_2023_BF.csv" )
